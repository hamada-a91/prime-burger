...
export const NAV_ITEMS: { key: RouteKey; label: 'nav.home' | 'nav.about' | 'nav.menu' | 'nav.gallery' | 'nav.reservation' }[] = [
        ...
        >
            <div className="container-site flex h-[72px] items-center justify-between gap-4">
                <LocaleLink to="home" className="flex items-center gap-3 shrink-0" aria-label={site.name}>
                    <img src={site.logo} alt="" width={56} height={50} className="h-12 w-auto" fetchPriority="high" />
                    <span className="font-display text-2xl leading-none text-foreground hidden sm:inline">Prime Burger</span>
                </LocaleLink>
                ...
                <div className="hidden lg:flex items-center gap-3">
                    <a href={phoneHref} className="text-sm font-semibold text-muted-foreground hover:text-foreground transition-colors inline-flex items-center gap-2">
